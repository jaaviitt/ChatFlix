...
public class GestorBaseDatos {
    ...
    private static final String URL = "jdbc:sqlite:chatflix.db";
    ...
    public static void inicializar() {
        try (Connection conn = DriverManager.getConnection(URL);
            ...
            // 2. TABLA CONTACTOS
            stmt.executeUpdate("CREATE TABLE IF NOT EXISTS contactos (" +
                    "id_usuario INTEGER, " +
                    "id_contacto INTEGER, " +
            ...
            // 4. TABLA MIEMBROS_GRUPO
            stmt.executeUpdate("CREATE TABLE IF NOT EXISTS miembros_grupo (" +
                    "id_grupo INTEGER, " +
                    "id_usuario INTEGER, " +
            ...
            // 5. TABLA MENSAJES
            stmt.executeUpdate("CREATE TABLE IF NOT EXISTS mensajes (" +
            ...
            // 6. TABLA FAVORITOS
            stmt.executeUpdate("CREATE TABLE IF NOT EXISTS favoritos (" +
                    "id_usuario INTEGER NOT NULL, " +
                    "id_favorito INTEGER NOT NULL, " +
                    "PRIMARY KEY (id_usuario, id_favorito), " +
                    "FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario) ON DELETE CASCADE, " +
                    "FOREIGN KEY (id_favorito) REFERENCES usuarios(id_usuario) ON DELETE CASCADE)");
